...
export function ThemeToggle({ className = '', showLabel = false }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={`flex cursor-pointer items-center rounded-md p-2 text-gray-600 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white ${className}`}
